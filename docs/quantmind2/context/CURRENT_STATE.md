...
- This is a mapping contract only. Detail ORM tables, domain mappers,
  migration, real schema/table creation, PostgreSQL verification, production
  Repository, Session/UoW, and transaction code remain unimplemented.
- Latest Implementation Run: generated by this task and referenced in Handoff.
