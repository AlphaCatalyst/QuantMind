...
| QM2-KI-021 | medium | open | Ledger ORM metadata now covers nine objects including Component/ADR references; Limitation/RecommendedTask mappings, domain mappers, migration, schema deployment, production Repository, UoW, and PostgreSQL integration evidence remain absent. |
