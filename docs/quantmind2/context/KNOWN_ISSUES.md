...
| QM2-KI-021 | medium | open | Ledger ORM metadata now covers all eleven current target objects, but domain mappers, migration, schema deployment, production Repository, UoW, and PostgreSQL integration evidence remain absent. No annotation data has been written. |
