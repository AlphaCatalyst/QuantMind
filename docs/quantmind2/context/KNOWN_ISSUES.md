...
| QM2-KI-021 | medium | open | Ledger ORM metadata covers all eleven objects and Task mapping now exists, but the other ten object mappers, migration, schema deployment, production Repository, UoW, and PostgreSQL integration evidence remain absent. |
