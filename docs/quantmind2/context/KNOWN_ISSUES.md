...
| QM2-KI-048 | high | open | R1-005 finds likely overfit evidence for Candidate B's separate factor/strategy optimization and both Candidates' combined optimization. The decision is advisory; optimizer defaults and production behavior remain unchanged. |
