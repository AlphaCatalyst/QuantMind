...
| QM2-KI-021 | medium | open | Ledger ORM metadata covers all eleven objects and Task/Run mapping now exists, but the other nine object mappers, migration, schema deployment, production Repository, UoW, and PostgreSQL integration evidence remain absent. |
