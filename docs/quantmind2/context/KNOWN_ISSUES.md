...
| QM2-KI-032 | high | open | The Codex CLI executable exists and was invoked through the real read-only structured adapter, but both bounded attempts returned exit code 1 before a structured Proposal; QM2-P0-008 remains partial and requires Provider enablement/completion. |
