...
class QuantMind2ContextBootstrapTests(unittest.TestCase):
    ...
    def test_handoff_records_security_termination_audit(self):
        ...
        self.assertEqual(handoff["current_task"], "QM2-R2-006")
        ...
        self.assertIn("two-family final-lock gate", text)
        self.assertIn("40 formal Qlib calls", text)
        self.assertIn("stock_selection_signal_only", text)
        self.assertIn("zero Candidate Locks", text)
        self.assertIn("regime_specific_factor", text)
        self.assertIn("retain_for_regime_specific_research", text)
        self.assertIn("mtad1_308b2628", text)
        self.assertIn("afc1_5bae780e", text)
        self.assertIn("Twelve automatic rounds", text)
        ...
        self.assertIn("peel1_f96c3595", text)
        self.assertIn("arsv1_1d07cf5c", text)
        self.assertIn("arsr1_3cc6becd", text)
        self.assertIn("retrospective_research_only", text)
